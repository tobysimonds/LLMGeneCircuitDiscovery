...
def test_build_results_site_writes_interactive_bundle(tmp_path: Path) -> None:
                    ...
                    "interactions": [
                        {
                            ...
                            "evidence_summary": "SOX2 upregulates MYC.",
                            "pmid_citations": ["123"],
    ...
    for filename in [
        ...
        (run_dir / filename).write_text(json.dumps(graph_payload), encoding="utf-8")
    ...
    assert bundle["graphs"]["selected"]["edges"][0]["direct_evidence"][0]["source_gene"] == "SOX2"
